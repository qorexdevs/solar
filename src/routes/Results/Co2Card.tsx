...
export function Co2Card({ annualYear1, cumulative, lifespanYears }: Props) {
  return (
    <section className="bg-primary-container rounded-xl p-md text-on-primary shadow-card relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center gap-md">
        <div className="p-4 bg-on-primary/10 rounded-full self-start">
          <Icon name="co2" className="text-4xl" />
        </div>
        <div className="flex-1">
          <h3 className="font-body-lg text-body-lg mb-1">CO₂ Offset</h3>
          <div className="font-data-display text-data-display">
            {formatTonnes(annualYear1)} / yr
          </div>
          <p className="font-label-sm text-label-sm text-on-primary/80 mt-1">
